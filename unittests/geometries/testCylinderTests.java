...
class CylinderTest {
    ...
    void findIntersectionsTest() {
        ...
        List<Point> result = cylinder.findIntersections(
                new Ray(
                        new Point(5,0,0),
                        new Vector(0,0,1)
                )
        ...
        result = cylinder.findIntersections(
                new Ray(
                        new Point(2.5,0,1),
                        new Vector(0,0,1)
                )
        ...
        assertEquals(2, result.size(), "Wrong number of points");
        assertEquals(List.of(new Point(1,0,0.5), new Point(3,0,0.5)), result,
        ...
        assertEquals(2,result.size(), "Wrong number of points");
        assertEquals(List.of(new Point(2,0,0), new Point(3,0,1)), result,
                "Bad intersection points");
